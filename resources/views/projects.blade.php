       ...
       <div class="overlay">
              <div class="container">
                     <div class="row">
                            ...
                            <div class="col-sm-6">
                                   <h6 class="breadcrumb"><a href="{{ route('index') }}">Home</a> / Project</h6>
                            </div>
                     </div>
              </div>
       </div>
...
<section id="about-sec">
       <div class="container">
              <div class="text-center row">
                     ...
                     <div class="avatar-inner"><img src="{{asset('storage/uploads/'.$project->passport) }}" width="300px"></div>
                     <hr>
                     <p class="text-justify text-lead">{!! $project->post !!}</p>
              </div>
       </div>
</section>
